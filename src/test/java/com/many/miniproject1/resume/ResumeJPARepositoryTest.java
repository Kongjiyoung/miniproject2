...
//    }
    ...
    public void findByResumeUserIdAndSessionUserId_test() {
        ...
        // when
        List<Resume> resumeList = resumeJPARepository.findByResumeUserIdAndSessionUserId(1, 1);

        // then
        System.out.println("findByResumeUserIdAndSessionUserId_test:" + resumeList);
